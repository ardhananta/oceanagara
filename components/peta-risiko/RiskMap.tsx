...
import type { GfwVesselEvent, RiskPoint } from '@/app/types/maritime';
...
export default function RiskMap({ riskPoints, centerLat, centerLon, regionName, vessels = [], nearbySources = [] }: RiskMapProps) {
  ...
  }, [leafletReady, riskPoints, vessels, nearbySources]);
  ...
  return (
    <div className="relative w-full h-full flex flex-col">
      {/* Map container */}
      <div ref={mapRef} className="flex-1 w-full rounded-xl overflow-hidden" style={{ minHeight: 520 }} />

      {/* Legend */}
      <div className="absolute top-4 left-4 z-[999] bg-white/95 backdrop-blur border border-zinc-200 rounded-xl px-4 py-3 space-y-2 shadow-lg max-w-[210px]">
      ...
      <div className="absolute top-4 right-4 z-[999] bg-white/95 backdrop-blur border border-zinc-200 rounded-xl px-3 py-2 max-w-[220px] shadow-lg">
        <p className="text-[10px] text-[#162e52] font-bold uppercase tracking-widest">Wilayah Analisis</p>
        <p className="text-xs text-zinc-800 font-semibold mt-0.5 line-clamp-2">{regionName}</p>
      </div>
