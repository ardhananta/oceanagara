      ...
      <main className="flex-grow p-6 md:p-12 max-w-5xl w-full mx-auto flex flex-col justify-center">
        <div className="border border-zinc-800 p-8 md:p-12 bg-zinc-900/50 backdrop-blur-sm relative">
          ...
          <h1 className="text-2xl md:text-3xl font-extrabold uppercase tracking-tight mb-4 text-white">
            Selamat Datang, {profile?.displayName || 'Masyarakat'}!
          </h1>
          <p className="text-sm text-zinc-400 leading-relaxed mb-8 max-w-xl">
            Anda masuk ke Dashboard khusus Masyarakat Umum. Gunakan menu navigasi untuk memantau data penyebaran kapal tangkap, statistik hasil laut publik, serta info pesisir nasional secara transparan.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-zinc-800">
            <div>
              <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest block mb-1">Profesi</span>
              <p className="text-sm font-semibold text-white uppercase">{String(profile?.pekerjaan || '-')}</p>
            </div>
            <div>
              <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest block mb-1">Institusi / Organisasi</span>
